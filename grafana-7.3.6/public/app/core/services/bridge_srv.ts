...
import { dispatch, store } from 'grafana-7.3.6/public/app/store/store';
...
import { getDashboardSrv } from 'grafana-7.3.6/public/app/features/dashboard/services/DashboardSrv';
import { templateVarsChangedInUrl } from 'grafana-7.3.6/public/app/features/variables/state/actions';
