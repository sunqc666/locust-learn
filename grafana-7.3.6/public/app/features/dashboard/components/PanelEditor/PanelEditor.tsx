...
import { appEvents } from 'grafana-7.3.6/public/app/core/core';
...
import { SubMenuItems } from 'grafana-7.3.6/public/app/features/dashboard/components/SubMenu/SubMenuItems';
import { BackButton } from 'grafana-7.3.6/public/app/core/components/BackButton/BackButton';
import { SaveDashboardModalProxy } from '../SaveDashboard/SaveDashboardModalProxy';
import { DashboardPanel } from '../../dashgrid/DashboardPanel';

import { initPanelEditor, panelEditorCleanUp, updatePanelEditorUIState } from './state/actions';

import { updateTimeZoneForSession } from 'grafana-7.3.6/public/app/features/profile/state/reducers';
...
import { getVariables } from 'grafana-7.3.6/public/app/features/variables/state/selectors';

import { CoreEvents, LocationState, StoreState } from 'app/types';
import { DisplayMode, displayModes, PanelEditorTab } from './types';
import { VariableModel } from 'grafana-7.3.6/public/app/features/variables/types';
