...
import { GRID_CELL_HEIGHT, GRID_CELL_VMARGIN, GRID_COLUMN_COUNT, REPEAT_DIR_VERTICAL } from 'grafana-7.3.6/public/app/core/constants';
// Utils & Services
import { Emitter } from 'grafana-7.3.6/public/app/core/utils/emitter';
import { contextSrv } from 'grafana-7.3.6/public/app/core/services/context_srv';
import sortByKeys from 'grafana-7.3.6/public/app/core/utils/sort_by_keys';
// Types
...
import { GetVariables, getVariables } from 'grafana-7.3.6/public/app/features/variables/state/selectors';
import { variableAdapters } from 'grafana-7.3.6/public/app/features/variables/adapters';
import { onTimeRangeUpdated } from 'grafana-7.3.6/public/app/features/variables/state/actions';
