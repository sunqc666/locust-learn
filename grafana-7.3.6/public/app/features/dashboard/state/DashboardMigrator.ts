...
import {
  ...
  GRID_COLUMN_COUNT,
  MIN_PANEL_HEIGHT,
} from 'grafana-7.3.6/public/app/core/constants';
import { isMulti, isQuery } from 'grafana-7.3.6/public/app/features/variables/guard';
import { alignCurrentWithMulti } from 'grafana-7.3.6/public/app/features/variables/shared/multiOptions';
