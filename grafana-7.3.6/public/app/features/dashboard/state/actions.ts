...
import { createSuccessNotification } from 'grafana-7.3.6/public/app/core/copy/appNotification';
// Actions
...
import { loadPanelPlugin } from 'grafana-7.3.6/public/app/features/plugins/state/actions';
// Types
