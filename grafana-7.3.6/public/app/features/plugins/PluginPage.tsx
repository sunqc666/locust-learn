...
import { getNotFoundNav } from 'grafana-7.3.6/public/app/core/nav_model_srv';
...
interface State {
  ...
  nav: NavModel;
  defaultPage: string; // The first configured one or readme.md
}

const PAGE_ID_README = 'readme.md';
...
function getPluginTabsNav(
  ...
  // We allow non admins to see plugins but only their readme.md. Config is hidden even though the API needs to be
