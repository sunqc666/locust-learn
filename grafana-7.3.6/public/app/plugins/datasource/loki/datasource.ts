...
import { addLabelToQuery } from 'grafana-7.3.6/public/app/plugins/datasource/prometheus/add_label_to_query';
import { getTimeSrv, TimeSrv } from 'grafana-7.3.6/public/app/features/dashboard/services/TimeSrv';
import { convertToWebSocketUrl } from 'grafana-7.3.6/public/app/core/utils/explore';
